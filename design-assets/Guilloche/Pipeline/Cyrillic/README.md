...
- `../../App/Blend/Cyrillic/` and `../../App/Rotation/Cyrillic/`: finalized generated SVGs once the pipeline output is visually approved and ready to feed into the app's `SVGToSwift` ingestion flow.
...
Run `Tools/package-cyrillic-guilloche.py` from the repo root to combine these
per-layer SVGs into the app ingestion format:

- `design-assets/Guilloche/App/Blend/Cyrillic/{codepoint}_{Circle,Square,Polygon}.svg`
